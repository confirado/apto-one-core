...
namespace Apto\Plugins\FileUpload\Domain\Core\Model\Service\Converter;

class MimeTypeExtensionConverter
{
    /**
     * @param string $extension
     * @return array
     */
    public function extensionToMimeTypes(string $extension): array
    {
        $mimeTypes = $this->getMimeType($extension);
     ...
     * @return array
     */
    public function extensionsToMimeTypes(array $extensions): array
    {
        $collectedMimeTypes = [];
        ...
        foreach ($extensions as $extension) {
            ...
            foreach ($mimeTypes as $mimeType) {
                if (in_array($mimeType, $collectedMimeTypes, true)) {
                    continue;
                }

                $collectedMimeTypes[] = $mimeType;
            }
        }
    ...
    private function getMimeType(string $extension)
    {
        $mimeTypes = array(
            ...
            'psd' => array('image/vnd.adobe.photoshop', 'application/x-photoshop', 'application/photoshop', 'application/psd', 'image/psd'),
