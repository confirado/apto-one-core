import Template from './price-per-unit-element-definition.component.html';
import DialogTemplate from './price-per-unit-element-dialog.html';
...
class Controller {
    ...
    setActiveValue() {
        this.configurationService.setSingleValue(this.section.id, this.element.id, null, null);
...
export default ['pricePerUnitElementDefinition', Component];