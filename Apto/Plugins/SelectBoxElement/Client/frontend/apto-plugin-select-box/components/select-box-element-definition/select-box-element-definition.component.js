import Template from './select-box-element-definition.component.html';
import DialogTemplate from './select-box-element-definition.dialog.html';
...
export default ['selectBoxElementDefinition', Component];