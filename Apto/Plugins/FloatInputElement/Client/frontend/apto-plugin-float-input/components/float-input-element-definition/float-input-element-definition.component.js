import Template from './float-input-element-definition.component.html';
import DialogTemplate from './float-input-element-dialog.html';
...
export default ['floatInputElementDefinition', Component];