...
import DialogTemplate from './width-height-element.dialog.html';

const WidthHeightElementControllerInject = ['$ngRedux', 'ngDialog', 'LanguageFactory', 'ConfigurationService'];
