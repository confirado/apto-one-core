...
import { HumanReadableFullState } from '@apto-catalog-frontend-configuration-model';
import { DialogDataInterface } from '@apto-catalog-frontend/components/common/dialogs/dialog-data-interface';
import { selectConfigurationLoading, selectHumanReadableFullState } from '@apto-catalog-frontend-configuration-selectors';
import { addOfferConfiguration, addOfferConfigurationSuccess } from '@apto-catalog-frontend-configuration-actions';
