...
import { ConfigurationEffects } from '@apto-catalog-frontend-configuration-effects';
...
import { SummaryConfigurationComponent } from '@apto-catalog-frontend-summary-configuration';
import { SummarySectionPriceComponent } from '@apto-catalog-frontend-summary-section-price';
import { SummaryFinishMessageComponent } from '@apto-catalog-frontend-summary-finish-message';
