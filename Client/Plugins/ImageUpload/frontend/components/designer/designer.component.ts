...
export class DesignerComponent implements OnInit, AfterViewInit {
    ...
    @ViewChild('htmlRenderImage') private htmlRenderImage: ElementRef;
    @ViewChild('htmlMiddle') private htmlMiddle: ElementRef;
    ...
    @HostBinding('class.visible') @Input() public visible: boolean;
        ...
        for (const droppedFile of files) {
            if (droppedFile.fileEntry.isFile) {
                ...
                fileEntry.file((file: File) => {
                    this.imageUploadControl.setValue(file, { emitModelToViewChange: true });
                });
            }
        }
    }
